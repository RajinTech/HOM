...
class ListingEditContainer extends Component {
  constructor(props) {
    super(props);
    this.state = {
      street: this.props.listing.street.toString(),
      unit: this.props.listing.unit.toString(),
      city: this.props.listing.city.toString(),
      state: this.props.listing.state.toString(),
      zip: this.props.listing.zip.toString(),
      bedrooms: this.props.features.bedrooms.toString(),
      bathrooms: this.props.features.bathrooms.toString(),
      rent: this.props.features.rent.toString(),
      sq_ft: this.props.features.sq_ft.toString(),
      date_available: this.props.features.date_available.toString(),
      lease_length: this.props.features.lease_length.toString(),
      building_style: this.props.amenities.building_style.toString(),
      parking_spaces: this.props.amenities.parking_spaces.toString(),
      pets: this.props.amenities.pets.toString(),
      zoning: this.props.amenities.zoning.toString(),
      school_district: this.props.amenities.school_district.toString(),
      heating: this.props.amenities.heating.toString(),
      cooling: this.props.amenities.cooling.toString(),
      hud: this.props.amenities.hud.toString(),
      smoking: this.props.amenities.smoking.toString(),
      image: [this.props.pictures].toString(),
      error: false,
      submit_message: "",
      field_message: "",
      edit: false
